...
def normalize_tensor(tensor, idx, slices, Na):
    ...
    norm_tensor[:, slices[idx]] = tensor[:, slices[idx]] / Na[idx]
    return norm_tensor
...
class SupportLowRankWeights(nn.Module):
    ...
    This mirrors SupportLowRankRNN in modules.py but adapted to NeuroFlame.
    """

...
:GPTEL_TOOLS:
:GPTEL_BOUNDS: ((response (22205 25326) (25419 45520) (45524 54630)))
:END:
...
*** Parse the org file in context. Provide a new org file that runs with the new version of the package.

...
**** Fully connected
[[file:/LeonCarmin/NeuroTorch/src/branch/main/org/search/ring_attractor.org][Here]], a notebook that shows how to use NeuroTorch to locate ring attractors in parameter space.
**** Sparse
[[file:/LeonCarmin/NeuroTorch/src/branch/main/org/search/multi_stable.org][Here]], a notebook that shows how to use NeuroTorch to locate multistable balance states in parameter space.

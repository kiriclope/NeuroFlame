...
#+begin_src ipython
  ...
  model = Network(conf_name, name, REPO_ROOT, VERBOSE=0, DEVICE='cuda:1',
                  ...
                  TASK='dual_rand', LIVE_FF_UPDATE=1, DURATION=30, TAU_NMDA=[.1, .1])
...
:         [0., 1.]], device='cuda:1')
: torch.Size([4, 8000])
: Elapsed (with compilation) = 0h 3m 8s
: rates (100, 8000)
...
#+RESULTS:
: (100, 2)
: Cluster Centers: [[-0.02658858 -1.48497095]
:  [-1.1926028   0.06519158]]
: mean phi 42.92268040904239
: dphi -47.07731959095761
...
#+RESULTS:
[[file:./.ob-jupyter/67a55e610f2aa19c7dd7ece1ae15316af696058f.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/e53c3913acee3f31a20f56bfb87ab64ee9719d71.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/e06019252d83262d3a4915ff3bcb1a40fdafe7fa.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/3890eefe6a641e1670e91bd4452b23495b6cd851.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/0118fda9a693aa3f679b4d33a3bc60b55baafe27.png]]

...
#+begin_src ipython
  ...
  class AngularErrorLoss(nn.Module):
      ...
      def forward(self, readout, targets):
          ...
          loss += F.relu(ones - m1[:, self.rwd_idx] / m0[:, self.rwd_idx]).mean()
...
#+RESULTS:
: ff_input torch.Size([1024, 355, 1000]) labels torch.Size([1024, 31])
...
#+RESULTS:
: torch.Size([819, 355, 1000]) torch.Size([205, 355, 1000])
: torch.Size([819, 31]) torch.Size([205, 31])
...
#+RESULTS:
#+begin_example
Epoch 1/15, Training Loss: 1.2681, Validation Loss: 1.0810
Epoch 2/15, Training Loss: 1.0550, Validation Loss: 1.0739
Epoch 3/15, Training Loss: 0.8983, Validation Loss: 1.0724
Epoch 4/15, Training Loss: 1.3183, Validation Loss: 1.0711
Epoch 5/15, Training Loss: 1.2293, Validation Loss: 1.0699
Epoch 6/15, Training Loss: 1.2128, Validation Loss: 1.0685
Epoch 7/15, Training Loss: 0.9416, Validation Loss: 1.0668
Epoch 8/15, Training Loss: 0.9192, Validation Loss: 1.0657
Epoch 9/15, Training Loss: 1.0333, Validation Loss: 1.0640
Epoch 10/15, Training Loss: 0.9060, Validation Loss: 1.0624
Epoch 11/15, Training Loss: 1.0202, Validation Loss: 1.0601
Epoch 12/15, Training Loss: 1.1799, Validation Loss: 1.0538
Epoch 13/15, Training Loss: 0.9549, Validation Loss: 1.0325
Epoch 14/15, Training Loss: 1.1178, Validation Loss: 0.9929
#+end_example
...
#+RESULTS:
: 4b159158-7e56-4e4b-ad46-cca703d0bfa2
...
#+RESULTS:
: 0baae174-6c68-450f-884d-5cb122d7f08a
...
#+RESULTS:
: 4a00b3fc-944d-4ee7-9036-55eec3bb0fc3
...
#+RESULTS:
: 49e92fa3-4b8c-43d4-b2ee-abab2f3311de
...
#+RESULTS:
: 5ac283a9-c475-491e-ae10-0a96ed6ff41a
...
#+RESULTS:
: 436cf44f-9b5c-4cc1-9b26-24a21cb99022
...
#+RESULTS:
: 2d77d827-bb83-4727-b4c3-52d191aab5ea
...
#+RESULTS:
: a4849d9a-5c29-4f7b-bd15-5c66ec0da69c
...
#+RESULTS:
: 55c96eda-a1ab-4831-921f-bc2980713804
...
#+RESULTS:
: fc9cd526-863b-4ffb-9e7a-9e0951332b5f
...
#+RESULTS:
: 1463ddad-d576-4989-a24b-3ae9821c264f


#+begin_src ipython
plot_rates_selec(rates, idx=30, thresh=1)
#+end_src

#+RESULTS:
: 21e9314d-163b-4ddc-8425-7245b58dec8d
...
#+RESULTS:
: b227cefd-8923-4a32-ad92-6ec9055bc9e4

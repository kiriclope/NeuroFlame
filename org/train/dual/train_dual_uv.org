...
#+begin_src ipython
model.Wab_train = model.low_rank(model.LR_NORM, model.LR_CLAMP)
W_stp_T = torch.round((model.W_stp_T / torch.sqrt(model.Ka[0]) + model.Wab_train[model.slices[0], model.slices[0]] ) * torch.sqrt(model.Ka[0]), decimals=5)
#+end_src

#+RESULTS:

#+begin_src ipython
print((W_stp_T<0).sum() / W_stp_T.shape[0]**2)
#+end_src
...
#+begin_example
Sample Classification
Epoch 1/15, Training Loss: 3.9116, Validation Loss: 3.8288, Angle(U, W) : 89.0 °
Epoch 2/15, Training Loss: 3.7806, Validation Loss: 3.7595, Angle(U, W) : 89.0 °
Epoch 3/15, Training Loss: 3.6778, Validation Loss: 3.6150, Angle(U, W) : 89.0 °
Epoch 4/15, Training Loss: 3.6349, Validation Loss: 3.6698, Angle(U, W) : 90.0 °
Epoch 5/15, Training Loss: 3.5836, Validation Loss: 3.5304, Angle(U, W) : 90.0 °
Epoch 6/15, Training Loss: 3.5306, Validation Loss: 3.4942, Angle(U, W) : 90.0 °
Epoch 7/15, Training Loss: 3.4541, Validation Loss: 3.3771, Angle(U, W) : 90.0 °
Epoch 8/15, Training Loss: 3.4073, Validation Loss: 3.3477, Angle(U, W) : 89.0 °
Epoch 9/15, Training Loss: 3.3432, Validation Loss: 3.2704, Angle(U, W) : 89.0 °
Epoch 10/15, Training Loss: 3.2388, Validation Loss: 3.2190, Angle(U, W) : 89.0 °
Epoch 11/15, Training Loss: 3.2199, Validation Loss: 3.1867, Angle(U, W) : 89.0 °
Epoch 12/15, Training Loss: 3.1715, Validation Loss: 3.1140, Angle(U, W) : 89.0 °
Epoch 13/15, Training Loss: 3.1004, Validation Loss: 3.1256, Angle(U, W) : 89.0 °
Epoch 14/15, Training Loss: 3.0140, Validation Loss: 3.1860, Angle(U, W) : 89.0 °
Epoch 15/15, Training Loss: 2.9524, Validation Loss: 2.9750, Angle(U, W) : 89.0 °
Elapsed (with compilation) = 0h 11m 58s
#+end_example
...
:RESULTS:
: readout (20, 91, 2)
[[./.ob-jupyter/d22f64fff0aaf86857943f699e0150879fbca920.png]]
:END:
...
[[./.ob-jupyter/56a0c3a72f8102a7bbe03b413bb7b96df4c8e12b.png]]
:END:
...
:RESULTS:
: ksi torch.Size([4, 750])
[[./.ob-jupyter/d54bb95328b383817d329df77f5279b7d6fed49a.png]]
:END:
...
#+RESULTS:
[[./.ob-jupyter/9a718c524ae650e20e9190fab484f95ea514e596.png]]
...
#+RESULTS:
[[./.ob-jupyter/d56bde48e575da034bc36ad03445c100bc29a415.png]]

#+begin_src ipython
model.Wab_train = model.low_rank(model.LR_NORM, model.LR_CLAMP)
W_stp_T = torch.round((model.W_stp_T / torch.sqrt(model.Ka[0]) + model.Wab_train[model.slices[0], model.slices[0]] ) * torch.sqrt(model.Ka[0]), decimals=3)
#+end_src
...
#+begin_src ipython
plt.hist(W_stp_T[2, :].cpu().detach(), bins=100)
plt.show()
#+end_src

#+RESULTS:
[[./.ob-jupyter/67656a88e6c6b10b0f93af644b404130f4d6266d.png]]

#+begin_src ipython
Cij = -W_stp_T.cpu().detach().numpy()
...
#+RESULTS:
[[./.ob-jupyter/8322c804cbcfd433fb9448597ef5a8756913ca85.png]]
...
#+begin_example
training DPA
Epoch 1/15, Training Loss: 3.3587, Validation Loss: 2.3844, Angle(U, W) : 88.0 °
Epoch 2/15, Training Loss: 0.8165, Validation Loss: 0.0343, Angle(U, W) : 89.0 °
Epoch 3/15, Training Loss: 0.0254, Validation Loss: 0.0191, Angle(U, W) : 89.0 °
Epoch 4/15, Training Loss: 0.0212, Validation Loss: 0.0229, Angle(U, W) : 89.0 °
Epoch 5/15, Training Loss: 0.0174, Validation Loss: 0.0179, Angle(U, W) : 90.0 °
Epoch 6/15, Training Loss: 0.0157, Validation Loss: 0.0138, Angle(U, W) : 89.0 °
Epoch 7/15, Training Loss: 0.0135, Validation Loss: 0.0127, Angle(U, W) : 90.0 °
Epoch 8/15, Training Loss: 0.0124, Validation Loss: 0.0138, Angle(U, W) : 90.0 °
Epoch 9/15, Training Loss: 0.0115, Validation Loss: 0.0115, Angle(U, W) : 90.0 °
Epoch 10/15, Training Loss: 0.0115, Validation Loss: 0.0109, Angle(U, W) : 90.0 °
Epoch 11/15, Training Loss: 0.0112, Validation Loss: 0.0247, Angle(U, W) : 90.0 °
Epoch 12/15, Training Loss: 0.0111, Validation Loss: 0.0090, Angle(U, W) : 90.0 °
Epoch 13/15, Training Loss: 0.0103, Validation Loss: 0.0080, Angle(U, W) : 90.0 °
Epoch 14/15, Training Loss: 0.0101, Validation Loss: 0.0079, Angle(U, W) : 90.0 °
Epoch 15/15, Training Loss: 0.0094, Validation Loss: 0.0134, Angle(U, W) : 90.0 °
Elapsed (with compilation) = 0h 13m 12s
#+end_example
...
#+RESULTS:
[[./.ob-jupyter/90ce4ca5d91ed0b061fdfb09a990aa0ec199e1dd.png]]
...
:RESULTS:
: ksi torch.Size([4, 750])
[[./.ob-jupyter/65c371ec2838f52731b358ef16bff7ab06b60fad.png]]
:END:
...
#+RESULTS:
[[./.ob-jupyter/d2f647ea1bbe45a03aba0d9d5cc51d6832ccd012.png]]
...
#+RESULTS:
[[./.ob-jupyter/5b025556bcf087ed6ba21e0c3b8c67c9e53cda3c.png]]
...
#+begin_example
training DRT
Epoch 1/15, Training Loss: 1.9879, Validation Loss: 0.0535, Angle(U, W) : 91.0 °
Epoch 2/15, Training Loss: 0.0608, Validation Loss: 0.0492, Angle(U, W) : 91.0 °
Epoch 3/15, Training Loss: 0.0492, Validation Loss: 0.0440, Angle(U, W) : 91.0 °
Epoch 4/15, Training Loss: 0.0454, Validation Loss: 0.0401, Angle(U, W) : 91.0 °
Epoch 5/15, Training Loss: 0.0425, Validation Loss: 0.0374, Angle(U, W) : 91.0 °
Epoch 6/15, Training Loss: 0.0401, Validation Loss: 0.0352, Angle(U, W) : 91.0 °
Epoch 7/15, Training Loss: 0.0366, Validation Loss: 0.0326, Angle(U, W) : 91.0 °
Epoch 8/15, Training Loss: 0.0346, Validation Loss: 0.0306, Angle(U, W) : 91.0 °
Epoch 9/15, Training Loss: 0.0323, Validation Loss: 0.0305, Angle(U, W) : 91.0 °
Epoch 10/15, Training Loss: 0.0308, Validation Loss: 0.0272, Angle(U, W) : 91.0 °
Epoch 11/15, Training Loss: 0.0300, Validation Loss: 0.0266, Angle(U, W) : 91.0 °
Epoch 12/15, Training Loss: 0.0253, Validation Loss: 0.0238, Angle(U, W) : 91.0 °
Epoch 13/15, Training Loss: 0.0252, Validation Loss: 0.0229, Angle(U, W) : 91.0 °
Epoch 14/15, Training Loss: 0.0247, Validation Loss: 0.0305, Angle(U, W) : 91.0 °
Epoch 15/15, Training Loss: 0.0238, Validation Loss: 0.0242, Angle(U, W) : 91.0 °
Elapsed (with compilation) = 0h 11m 56s
#+end_example
...
#+RESULTS:
[[./.ob-jupyter/a62522bd5b319e38006946a8692332a6d57526b2.png]]
...
#+RESULTS:
[[./.ob-jupyter/029e687eea3fc70ead4a5ac0517955593824143b.png]]
...
#+RESULTS:
[[./.ob-jupyter/c3d1ff7d2343fc4ed8488a4f2e95d2e22a2f41cc.png]]
...
#+RESULTS:
: ae66d664-1a44-49bb-9bc9-0349f868e327
...
#+RESULTS:
: 6a33572b-6037-4cb5-8ae0-a7c416bf6dc3
...
#+RESULTS:
: 9a811593-0434-471f-b73b-fb997973a49f
...
#+RESULTS:
: cac2805d-b61e-48aa-a876-bb28f6ff5ffe
...
#+RESULTS:
: b170c961-a637-41ef-aa6b-8167a970aa85
...
#+RESULTS:
: f9510e59-ff11-45b6-aae4-216b8db8c6d7
...
#+RESULTS:
: 9d4c05f0-78d0-414e-9a0c-4b9634512e3a
...
#+RESULTS:
: 6d387fc8-1678-428e-a460-68b6918b7aa5
...
#+RESULTS:
: ac0daf9d-04de-4aa7-9abc-24c880331302
...
#+RESULTS:
: 575130b6-da92-45ea-8013-34785cf25d37
...
#+RESULTS:
: a3704d10-1506-4ba6-8c32-138ca63c1977
...
#+RESULTS:
: fbde9e95-fbf5-4e91-9c2d-53c56471afd1
...
#+RESULTS:
: 3eeddd39-ebb4-4874-a820-61aa5b064991
...
#+RESULTS:
: 4294a106-f602-41d2-b482-61d27d77f9c8
...
#+end_src
  ...
  #+RESULTS:
  : 42148fe0-85bb-4b7a-a1d0-b1d777068fd5
...
#+RESULTS:
: 388eaf31-ffe1-4837-a2c6-5905a89ead2c
...
#+RESULTS:
: e7652eee-1c27-4c89-8faa-04d5b2098c51
...
#+RESULTS:
: e7fd9a0e-45aa-487e-9b4a-dcb1541466f6
...
#+RESULTS:
: 299adc27-b0b7-440c-b91e-49e970a6dafd
...
#+RESULTS:
: 3708b2ea-9e9c-4e50-bd0c-b862ec3cde52
...
#+RESULTS:
: a14a26ca-2188-4467-8147-51b551eea090
...
#+RESULTS:
: 99c9ff70-8a3d-4671-84ca-f7937a497cba
...
#+RESULTS:
: d4dc6a59-52bd-433b-be1a-32b12041d13e
...
#+RESULTS:
: 03eaa6b6-7134-4659-b12e-91748fe3c9f6
...
#+RESULTS:
: 828524d0-605e-4b3d-af4e-10c818be2eb0
...
#+RESULTS:
: 13c2f8ee-9992-4d7c-8d68-339c47446d3b
...
#+RESULTS:
: 5ff9701c-5e10-4cf9-a283-82a2551502f2
...
#+RESULTS:
: 9753aa7b-770c-4a25-975a-083407f9192c
...
#+RESULTS:
: 733e4774-d08b-4a76-b105-21bf5fe208d8
...
#+RESULTS:
: 96456167-e565-4adf-8bd8-3479675428d8
...
#+RESULTS:
: 45d1ab2b-a0b6-4857-beb1-c8452611488c
...
#+RESULTS:
: 063ae2bd-680f-4033-8c78-952189edc0d1
...
#+RESULTS:
: e25c5421-d5e0-4ca9-a2e5-4f5780f655cb
...
#+RESULTS:
: 9e9bd8a2-4659-41e6-b181-919de00a947d
...
#+RESULTS:
: aaf926c6-7ce4-4d02-8396-e86883ca7d24
...
#+RESULTS:
: 962f7360-39bc-49e5-8fb5-441ba1b18bbb
...
#+RESULTS:
: 18f21450-e25d-42d6-b30d-546929dcc1c0
...
#+RESULTS:
: 418a02a4-6e89-498c-baf5-62a861205324
...
#+RESULTS:
: 52ec12a7-b214-4a3f-93e4-7e54b9ce60cd
...
#+RESULTS:
: 46f52b8e-ae6e-4d30-b386-4b8344f678c1
...
#+RESULTS:
: daf13004-f572-4883-bcd9-8ce54837b92a
...
#+RESULTS:
: 40e5c24b-3436-4b03-82b5-6dd118a02657
...
#+RESULTS:
: 568ba56c-6e8f-4b19-a79a-b89943124aee
...
#+RESULTS:
: 433d04b1-3c32-4d41-9db0-8f966fe42df3

...
#+RESULTS:
: 13fdf0e7-82bf-4bc7-9a0b-a2451e8f62a7
...
#+RESULTS:
: fa70f5d8-9276-4ecd-a5d4-fdfc9fae9b55
...
#+RESULTS:
: e1b6fb47-34b7-4207-b6f3-49c7c2913690
...
#+RESULTS:
: 56fb13b1-ade8-4078-833d-df74c2ac2862
...
#+RESULTS:
[[file:./figures/dual/figure_25.png]]
...
#+RESULTS:
: ff_input torch.Size([2048, 605, 1000]) labels torch.Size([2048, 3, 60])
...
#+RESULTS:
: torch.Size([1638, 605, 1000]) torch.Size([410, 605, 1000])
...
#+RESULTS:
: training DPA
: Epoch 1/10, Training Loss: 1.9752, Validation Loss: 1.9158
: Epoch 2/10, Training Loss: 1.7538, Validation Loss: 1.2338
: Epoch 3/10, Training Loss: 0.5896, Validation Loss: 0.1015
: Epoch 4/10, Training Loss: 0.0985, Validation Loss: 0.0914
: Stopping training as loss has fallen below the threshold: 0.09849306754767895, 0.09138645268068081
...
#+RESULTS:
: ff_input torch.Size([32, 605, 1000]) labels torch.Size([3, 32])
...
#+RESULTS:
: low_rank.V torch.Size([750, 3])
: low_rank.U torch.Size([750, 3])
...
#+begin_example
training DRT
Epoch 1/10, Training Loss: 0.7707, Validation Loss: 0.2921
Epoch 2/10, Training Loss: 0.2693, Validation Loss: 0.2531
Epoch 3/10, Training Loss: 0.2439, Validation Loss: 0.2330
Epoch 4/10, Training Loss: 0.2213, Validation Loss: 0.2106
Epoch 5/10, Training Loss: 0.2064, Validation Loss: 0.2008
Epoch 6/10, Training Loss: 0.1922, Validation Loss: 0.1859
Epoch 7/10, Training Loss: 0.1760, Validation Loss: 0.1691
Epoch 8/10, Training Loss: 0.1711, Validation Loss: 0.1655
Epoch 9/10, Training Loss: 0.1663, Validation Loss: 0.1656
Epoch 10/10, Training Loss: 0.1619, Validation Loss: 0.1634
Elapsed (with compilation) = 0h 7m 32s
#+end_example
 #+begin_src jupyter-python

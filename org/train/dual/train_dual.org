...
#+RESULTS:
[[file:./figures/dual/figure_27.png]]
...
#+RESULTS:
: EE post 0 pre 0 Jab tensor(0.0750, device='cuda:0') torch.Size([750, 750])
...
: (2, 4)
: (4, 4)
[[file:./figures/dual/figure_45.png]]
:END:
...
Cell In[95], line 7
      ...
      5 # ax[0].hist(U[:, 0], histtype='step', bins='auto')
      6 # ax[0].hist(U[:, 1], histtype='step', bins='auto')
----> 7 ax[0].hist(V[:, 0], histtype='step', bins='auto')
      8 ax[1].hist(V[:, 1], histtype='step', bins='auto')
      9 ax[0].set_xlabel('$ n_{AB} $')
...
#+end_example
[[file:./figures/dual/figure_46.png]]
:END:
...
ValueError                                Traceback (most recent call last)
Cell In[97], line 10
      8 for i in range(num_vectors):
      9     for j in range(num_vectors):
---> 10         cov_matrix[i][j] = angle_AB(vectors[i], vectors[j])
     12 # Mask the upper triangle
     13 mask = np.triu(np.ones_like(cov_matrix, dtype=bool))

Cell In[14], line 5, in angle_AB(A, B)
      2 A_norm = A / (np.linalg.norm(A) + 1e-5)
      3 B_norm = B / (np.linalg.norm(B) + 1e-5)
----> 5 return int(np.arccos(A_norm @ B_norm) * 180 / np.pi)
...
#+RESULTS:
[[file:./figures/dual/figure_49.png]]
...
#+RESULTS:
: cb47856d-fd47-425b-89c6-b9526de53117
...
#+RESULTS:
: 5b443baf-0255-4146-9bd9-e2ea5e831f9b
...
#+RESULTS:
: 599229d3-bc88-4119-9f13-bc11c7484772
...
#+RESULTS:
: 9dacba89-bb30-47a7-8c6d-315eb45abf3d
...
#+RESULTS:
: 1ebc1abf-c47c-4b02-966c-50683bc6d954
...
#+RESULTS:
: 51e17953-b90a-43d2-baa7-5ddaa0b4a0e1
...
#+RESULTS:
: 0b01beda-6cbe-4c93-84fc-dd13edbb5c1c
...
#+RESULTS:
: 501544d8-937b-441a-9dda-010b94061685
...
#+RESULTS:
: 61c9deeb-fae6-4fe8-b6c9-fc65077ddb65
...
#+RESULTS:
: 16dfd8b0-4c00-4d43-b9f9-bca29a17b9e4
...
#+RESULTS:
: 9b6c1b18-7b21-4603-a4e5-86840ec7e050
...
#+RESULTS:
: 239e1108-6089-4424-a0b7-563166fa1774
...
#+RESULTS:
: 0934781e-36f1-4d10-84ca-eaa91908f9ea
...
#+RESULTS:
: a282bce4-1ba9-42d8-9bf8-50f29483fe64
...
#+RESULTS:
: 13417628-ad98-449a-8038-6d0b1da0f8eb
...
#+RESULTS:
: 4cd4a259-4b8e-4521-a06c-a01b65130fa7
...
#+RESULTS:
: 05ae7f74-f29f-408d-a404-8d020143cc58
...
#+RESULTS:
: c9b6a366-5a83-4b6c-93a8-979844ca1b7d
...
#+RESULTS:
: 8e5368c8-a811-4b8c-8389-6247a6cb4bdd
...
#+RESULTS:
: 675d7e7e-7663-4ba8-80f2-cb40c36e5d7c
...
#+RESULTS:
: 52f8bf99-aa5c-4f54-9f8d-9d7632d8aa6b
...
#+RESULTS:
: 095f894b-7136-4be8-8f7c-1d1eb0d9cf24
...
#+RESULTS:
: 27ffc4bc-19d4-43dc-a95f-791189e0d18a
...
#+RESULTS:
: e704ea29-d4ab-4251-9f17-567a6da9f3d7
...
#+RESULTS:
: 5595bed7-da39-4f61-9ea5-60cb2455d5d1
...
#+RESULTS:
: 7e01fdfe-41f6-42da-bb40-92d09ce93483
...
#+RESULTS:
: b52b33e1-145c-47ef-ba5b-d76d26d2b61c
...
#+RESULTS:
: 690a2aba-d8e6-4812-b0fe-07568ed564f1
...
#+RESULTS:
: 904aacbf-7b54-4b38-9f42-0db95d7f500c
...
#+RESULTS:
: 0f9b6ca9-fe73-4b85-88f6-19f6332f6613
...
#+RESULTS:
: 8bc52497-bb2c-49ab-94af-67681bb8cb96
...
#+RESULTS:
: 30995ebf-f722-4a99-8332-3e69cd23e627
...
#+RESULTS:
: 06feec35-26e6-4229-903c-fc91f1a91e2f
...
#+RESULTS:
: 4871945b-f706-48cb-8bad-02d112639f90
...
#+RESULTS:
: f058cd18-0d8b-4187-8945-5237de3650c2
...
#+RESULTS:
: 09e3bf5f-6e61-4e82-86f6-358e8a5bb0ad
...
#+RESULTS:
: c3488018-a32f-481a-97dc-c23f5ca606da
...
#+RESULTS:
: 6e0fa754-b5a4-4744-9f71-54e151f4dd92
...
#+RESULTS:
: d7a50008-d16e-425c-a451-5f1f00bfb360
...
#+RESULTS:
: c6153095-333c-43aa-a5c8-79a759577c2b
...
#+RESULTS:
: 7c4cd0e7-a2a8-483a-8719-cb6776ffadba
...
#+RESULTS:
: 3666e592-0fd0-4361-bea9-ab2cb227ea9c
...
#+RESULTS:
: ed035d80-c345-4fd6-bc5c-3762d3e4ea5b
...
#+RESULTS:
: d6a0a6f6-c1a1-442e-b76e-ab6e0a5f7e9e
...
#+RESULTS:
: 703118fc-aa72-4cbc-8e67-536a8cbb0094
...
#+RESULTS:
: 218a09b9-14e4-4e69-8135-6ada33d8c61d
...
#+RESULTS:
: 17fd84de-7b30-4e9e-887b-b8f78270f564
...
#+RESULTS:
: 4cfe67ff-3bdd-4d44-95e1-442a0c95f311
...
#+RESULTS:
: 2c33abce-a813-4d12-a373-a47fb4bfeb45
...
#+RESULTS:
: 01bd0e25-4a7b-4c1f-abb4-4414b91817e2
...
#+RESULTS:
: 1d5a1a50-76e7-4666-b1c3-9ead822d7d6d
...
#+RESULTS:
: 3f82fe17-b77a-4130-ae74-93e1b0b01de8
...
#+RESULTS:
: 1dfeec49-e2d4-4277-a293-a93321b66593
...
#+RESULTS:
: defe1b3b-18a9-4e5b-b686-40e8936beb7f
...
#+RESULTS:
: 6de13dbf-61de-4463-8504-0316412ed721

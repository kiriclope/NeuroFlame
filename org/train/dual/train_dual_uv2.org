...
#+begin_src ipython
train_loader, val_loader = split_data(ff_input, labels, train_perc=0.8, batch_size=batch_size)
criterion = DualLoss(alpha=bce_alpha, thresh=thresh, stim_idx=stim_idx, gng_idx=gng_idx,cue_idx=cue_idx, rwd_idx=rwd_idx, zero_idx=zero_idx, class_bal=[1.0, 0.0, 1.0, 0.0], read_idx=[1, 0, 1, 1])
optimizer = optim.Adam(model.parameters(), lr=learning_rate)
#+end_src
...
#+RESULTS:
: training Dual
: Epoch 1/5, Training Loss: 0.6288, Validation Loss: 0.2417
: Epoch 2/5, Training Loss: 0.2065, Validation Loss: 0.1966
: Epoch 3/5, Training Loss: 0.1863, Validation Loss: 0.1825
: Epoch 4/5, Training Loss: 0.1732, Validation Loss: 0.1736
: Epoch 5/5, Training Loss: 0.1691, Validation Loss: 0.1680
: Elapsed (with compilation) = 0h 3m 43s

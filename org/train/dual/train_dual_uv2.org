...
#+RESULTS:
: training DPA
: Epoch 1/5, Training Loss: 3.2977, Validation Loss: 1.9840
: Epoch 2/5, Training Loss: 1.0140, Validation Loss: 0.3245
: Epoch 3/5, Training Loss: 0.1569, Validation Loss: 0.1343
: Epoch 4/5, Training Loss: 0.1233, Validation Loss: 0.1258
: Stopping training as loss has fallen below the threshold: 0.12327435039556943, 0.1257995952920216
...
#+RESULTS:
: 0a233dad-b202-4e32-8b22-82e5a06a5e63
...
#+RESULTS:
: d1055fe9-15da-4787-a423-9a638590eed6
...
#+RESULTS:
: training DRT
: Epoch 1/5, Training Loss: 1.0019, Validation Loss: 0.1305
: Epoch 2/5, Training Loss: 0.1069, Validation Loss: 0.0902
: Stopping training as loss has fallen below the threshold: 0.10688109165773942, 0.09024475489447757
...
#+RESULTS:
[[file:./figures/dual/figure_69.png]]
...
: (3, 120)
: (3, 120)
[[file:./figures/dual/figure_74.png]]
:END:
...
: (3, 120)
: (3, 120)
[[file:./figures/dual/figure_75.png]]
:END:
...
: (3, 120)
: (3, 120)
[[file:./figures/dual/figure_76.png]]
:END:
...
: Cell In[76], line 1
: ----> 1 criterion = DualScore(thresh=4, cue_idx=cue_idx, rwd_idx=rwd_idx, read_idx=[1, 1])
:       2 dpa_perf, drt_perf = criterion(model.readout, labels.clone())
:
: TypeError: DualScore.__init__() got an unexpected keyword argument 'thresh'
:END:
...
: Cell In[77], line 6
:       3 for i in [0, 1, -1]:
:       4         y = torch.where(labels[:, 2, 0]==i)
: ----> 6         mean_, sem_ = calculate_mean_accuracy_and_sem(dpa_perf[y])
:       7         dpa_mean.append(mean_)
:       8         dpa_sem.append(sem_)
:
: NameError: name 'dpa_perf' is not defined
:END:
...
: NameError                                 Traceback (most recent call last)
: Cell In[78], line 1
: ----> 1 drt_mean, drt_sem = calculate_mean_accuracy_and_sem(drt_perf)
:
: NameError: name 'drt_perf' is not defined
:END:
...
Cell In[79], line 5
      3 pal = ['r', 'b', 'g']
      4 for i in range(3):
----> 5     ax[0].errorbar(i, dpa_mean[i].item(), yerr=dpa_sem[i].item(), fmt='o', label='Naive',
      6                    color=pal[i], ecolor=pal[i], elinewidth=3, capsize=5)
      8 ax[0].set_xlim(-1, 4)
      9 # ax[0].set_ylim(0.4, 1.1)

IndexError: list index out of range
#+end_example
[[file:./figures/dual/figure_81.png]]
:END:
...
#+RESULTS:
: training Dual
: Epoch 1/5, Training Loss: 0.9197, Validation Loss: 0.3782
: Epoch 2/5, Training Loss: 0.2655, Validation Loss: 0.2039
: Epoch 3/5, Training Loss: 0.2008, Validation Loss: 0.1921
: Epoch 4/5, Training Loss: 0.1854, Validation Loss: 0.1875
: Epoch 5/5, Training Loss: 0.1748, Validation Loss: 0.1658
: Elapsed (with compilation) = 0h 5m 22s
...
#+RESULTS:
[[file:./figures/dual/figure_91.png]]
...
: (3, 120)
: (3, 120)
[[file:./figures/dual/figure_96.png]]
:END:
...
: (3, 120)
: (3, 120)
[[file:./figures/dual/figure_97.png]]
:END:
...
: (3, 120)
: (3, 120)
[[file:./figures/dual/figure_98.png]]
:END:
...
:       4         y = torch.where(labels[:, 2, 0]==i)
: ----> 6         mean_, sem_ = calculate_mean_accuracy_and_sem(dpa_perf[y])
:       7         dpa_mean2.append(mean_)
:       8         dpa_sem2.append(sem_)
:
: NameError: name 'dpa_perf' is not defined
:END:
...
: NameError                                 Traceback (most recent call last)
: Cell In[97], line 1
: ----> 1 drt_mean2, drt_sem2 = calculate_mean_accuracy_and_sem(drt_perf)
:
: NameError: name 'drt_perf' is not defined
:END:
...
----> 5     ax[0].errorbar(i, dpa_mean[i].item(), yerr=dpa_sem[i].item(), fmt='o', label='Naive',
      6                    color=pal[i], ecolor=pal[i], elinewidth=3, capsize=5)
      8     ax[0].errorbar(i+4, dpa_mean2[i].item(), yerr=dpa_sem2[i].item(), fmt='o', label='Naive',
      9                    color=pal[i], ecolor=pal[i], elinewidth=3, capsize=5)
     11 ax[0].set_xlim(-1, 7)

IndexError: list index out of range
#+end_example
[[file:./figures/dual/figure_103.png]]
:END:
...
#+RESULTS:
[[file:./figures/dual/figure_104.png]]
...
#+RESULTS:
[[file:./figures/dual/figure_105.png]]

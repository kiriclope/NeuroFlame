...
#+PROPERTY: header-args:ipython :results both :exports both :async yes :session dual_opto :kernel torch :exports results :output-dir ./figures/dual :file (lc/org-babel-tangle-figure-filename)
...
plt.savefig('../figures/dual/dual_perf__opto_%d.svg' % seed, dpi=300)

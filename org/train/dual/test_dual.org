...
: tensor(1.3964, device='cuda:1', requires_grad=True)
...
#+RESULTS:
: (750, 750)
: [0.00460721 0.00384529 0.00844966 0.00050916 0.00355934 0.
:  0.         0.00012298 0.00462146 0.00243993]
...
Traceback (most recent call last):
  File "/home/leon/mambaforge/lib/python3.14/site-packages/IPython/core/interactiveshell.py", line 3508, in run_code
    ...
    ~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/leon/tmp/ipykernel_3933265/3566526214.py", line 3, in <module>
    idxPair = (naive_labels[:, 0, 0]==1) & (naive_labels[:, 2, 0]==0)
               ^^^^^^^^^^^^
NameError: name 'naive_labels' is not defined. Did you mean: 'train_labels'?
...
w = model.odors[1].cpu().numpy() + model.odors[6].cpu().numpy()
ax[1].plot(np.linspace(0, 360, 750), uniform_filter1d(w[idx], size=75))
ax[1].set_ylabel("Weights Go/NoGo")
...
#+RESULTS:
[[file:./figures/dual/test/figure_96.png]]

...
#+PROPERTY: header-args:ipython :results both :exports both :async yes :session odr :kernel python3  :exports results :output-dir ./figures/odr :file (lc/org-babel-tangle-figure-filename)
...
:RESULTS:
: torch.Size([512])
[[file:./figures/odr/figure_22.png]]
:END:
...
#+end_src
#+RESULTS:
: torch.Size([1, 375]) torch.Size([512, 1])
: torch.Size([1, 375]) torch.Size([512, 1])
: torch.Size([512, 2, 1]) torch.Size([512, 555, 500]) torch.Size([512, 91])
...
:RESULTS:
: torch.Size([25593])
[[file:./figures/odr/figure_31.png]]
:END:
#+RESULTS:
...
: torch.Size([409, 555, 500]) torch.Size([103, 555, 500])
: torch.Size([409, 91]) torch.Size([103, 91])
:END:
...
#+RESULTS:
: ebde9a4a-9339-48cb-a80f-d5794c3b8ff5
...
#+RESULTS:
: 22680539-442d-449b-9122-33b86079abc6
...
#+RESULTS:
: c810fd7a-23df-4b1b-9bf2-d3655504fa7f
...
#+RESULTS:
: 4bcae591-7f4c-4566-b351-84495696823e
...
#+RESULTS:
: 495daf12-505f-4fe3-93a2-97df6d19c707
...
#+RESULTS:
: a566ee82-e4c8-4cb6-a7ec-4a02a3ced30f
...
#+RESULTS:
: 033bf88d-5826-49e3-8d8a-9fa35f087568
...
#+RESULTS:
: 76120ec6-394a-4ac0-87b8-f436769fbc0d
...
#+RESULTS:
: 8b106024-5879-433c-93b2-c5c677e59057
...
#+RESULTS:
: 669c7e40-15c0-4ded-b12c-4bd2129521f7
...
#+RESULTS:
: ad7e01a5-b4f7-4be9-b005-772adff2926a
...
#+RESULTS:
: b3cb51b4-8b9f-4e51-b9ee-7b2a6584c7a9
...
#+RESULTS:
: 9b22120f-52a4-4c14-af53-7726533f7543
...
#+RESULTS:
: 717f060d-d331-486b-b177-269c5045843f
...
#+RESULTS:
: d9bcd122-a28f-4a14-a0d9-0413c1a8d024
...
#+RESULTS:
: 1e437749-c2ad-436d-be33-43d26a8c0b5f
...
#+RESULTS:
: 198cbc07-6e57-4ea7-b927-578dd9df7aba
...
#+RESULTS:
: 9a5692f2-cfab-43de-a9e9-3395528e39b6

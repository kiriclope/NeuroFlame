...
#+PROPERTY: header-args:ipython :results both :exports both :async yes :session odr_seq_sb :kernel torch :exports results :output-dir ./figures/odr_sb :file (lc/org-babel-tangle-figure-filename)
...
: tensor(2.5162, device='cuda:0', requires_grad=True)
...
#+RESULTS:
: (50, 768, 4, 1) [0.13962634 3.6477382  0.47123888 2.7925267  2.4260077 ]
...
#+RESULTS:
: (50, 768, 121) [3.0457628 5.351302  2.8073006 2.3477678 3.8147376]
...
#+RESULTS:
: (768, 1) (768, 1) [ -61.999992 -108.00001    78.00001   -32.999992  -97.      ] (1, 2, 768, 121) [152.54442   -86.46101     1.401227  -98.336174   -4.7557516]

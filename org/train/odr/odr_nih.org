...
: tensor(2.8353, device='cuda:0', requires_grad=True)
...
#+RESULTS:
[[file:./figures/odr_seq_sb/figure_17.png]]
...
#+RESULTS:
: torch.Size([10, 855, 1000]) torch.Size([10, 131, 750])
...
#+RESULTS:
: 100% 50/50 [00:50<00:00,  1.01s/it]rates (50, 10, 131, 750)
...
#+RESULTS:
[[file:./figures/odr_seq_sb/figure_26.png]]
...
#+RESULTS:
: targ (250, 1) rel (250, 1) errors (25, 10, 131) idx start_idx (2, 10)
...
#+RESULTS:
[[file:./figures/odr_seq_sb/figure_41.png]]
...
#+RESULTS:
: save
: saving to ./models/nih//popt_controls.pkl
...
#+RESULTS:
[[file:./figures/odr_seq_sb/figure_55.png]]
...
:RESULTS:
: [8.] 500
[[file:./figures/odr_seq_sb/figure_59.png]]
:END:

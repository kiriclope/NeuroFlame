...
: 1050
: 450
: EE post 0 pre 0 Jab tensor(0.0632, device='cuda:0') torch.Size([1050, 1050])
...
#+RESULTS:
: Wab_train torch.Size([1050, 1050])
: J_STP torch.Size([])
...
#+RESULTS:
: torch.Size([512, 2, 1]) torch.Size([512, 1405, 1500]) torch.Size([512, 181])
...
: torch.Size([409, 1405, 1500]) torch.Size([103, 1405, 1500])
: torch.Size([409, 181]) torch.Size([103, 181])
:END:
...
#+RESULTS:
#+begin_example
Epoch 1/10, Training Loss: 0.9868, Validation Loss: 1.1922
Epoch 2/10, Training Loss: 0.9820, Validation Loss: 1.1873
Epoch 3/10, Training Loss: 0.9773, Validation Loss: 1.1824
Epoch 4/10, Training Loss: 0.9727, Validation Loss: 1.1794
Epoch 5/10, Training Loss: 0.9696, Validation Loss: 1.1765
Epoch 6/10, Training Loss: 0.9668, Validation Loss: 1.1738
Epoch 7/10, Training Loss: 0.9643, Validation Loss: 1.1714
Epoch 8/10, Training Loss: 0.9620, Validation Loss: 1.1693
Epoch 9/10, Training Loss: 0.9599, Validation Loss: 1.1673
Epoch 10/10, Training Loss: 0.9580, Validation Loss: 1.1656
Elapsed (with compilation) = 0h 2m 36s
#+end_example
...
#+RESULTS:
: odict_keys(['Wab_train', 'J_STP'])
: False
: Parameter containing:
: tensor(2.7004, device='cuda:0', requires_grad=True)
...
OutOfMemoryError: CUDA out of memory. Tried to allocate 4.02 GiB. GPU 0 has a total capacity of 23.60 GiB of which 3.13 GiB is free. Including non-PyTorch memory, this process has 20.45 GiB memory in use. Of the allocated memory 16.13 GiB is allocated by PyTorch, and 4.04 GiB is reserved by PyTorch but unallocated. If reserved but unallocated memory is large try setting PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True to avoid fragmentation.  See documentation for Memory Management  (https://pytorch.org/docs/stable/notes/cuda.html#environment-variables)
#+end_example
:END:
...
#+RESULTS:
: 8dc2f663-b9cc-4fbc-98f5-0beea92a531a
...
#+RESULTS:
: 9a9a1489-31ef-427a-96ad-64fc696c56e5
...
#+RESULTS:
: a8745ae3-c630-4162-8a8c-17b4ba5e9a96
...
#+RESULTS:
: 6e191617-ec42-4ce9-b709-725510608640

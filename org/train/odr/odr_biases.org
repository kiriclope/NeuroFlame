...
#+RESULTS:
: torch.Size([1, 750]) torch.Size([256, 1])
: torch.Size([1, 750]) torch.Size([256, 1])
: torch.Size([1, 750]) torch.Size([256, 1])
...
#+RESULTS:
:RESULTS:
: 90 289.0000023503334 292.2449159419797
...
Cell In[33], line 2
      1 # pref_locs[pref_locs<0] += 2* np.pi
----> 2 plt.hist(pref_locs * 180 / np.pi, bins=16)
      3 plt.xlabel('Pref Loc (°)')
      4 plt.ylabel('Count')
...
File ~/mambaforge/envs/torch/lib/python3.10/site-packages/numpy/lib/histograms.py:426, in _get_bin_edges(a, bins, range, weights)
...
File ~/mambaforge/envs/torch/lib/python3.10/site-packages/numpy/lib/histograms.py:323, in _get_outer_edges(a, range)
...
----> 2 ax[0].hist(pref_locs * 180 / np.pi, histtype='step', bins=16)
      3 # ax[0].hist(regressor.pref_locs_ * 180 / np.pi, histtype='step', bins=16)
      4 ax[0].set_ylabel('Count')
...
ref_loc = (reference - target_loc) * np.pi / 180.0
...
:       4 else:
: ----> 5         pkl_save(landscape, 'landscape', path="/home/leon/")
:
...
#+RESULTS:
: saving to /home/leon//unique_angles.pkl
: saving to /home/leon//tuning_curve.pkl
: saving to /home/leon//center_tuning_curve.pkl
: saving to /home/leon//pref_locs.pkl
...
#+RESULTS:
:RESULTS:
: 11 -116.43620187568833 0.17597336
...
#+RESULTS:
: saving to /home/leon//dist2ref.pkl
...
[1;32m      1[0m fig, ax [38;5;241m=[39m plt[38;5;241m.[39msubplots([38;5;241m1[39m, [38;5;241m2[39m, figsize[38;5;241m=[39m[[38;5;241m2[39m[38;5;241m*[39mwidth, height])
[0;32m----> 3[0m [41max[49m[41m[[49m[38;5;241;41m0[39;49m[41m][49m[38;5;241;41m.[39;49m[41mhist[49m[41m([49m[41mosi[49m[38;5;241;41m.[39;49m[41mcpu[49m[41m([49m[41m)[49m[38;5;241;41m.[39;49m[41mdetach[49m[41m([49m[41m)[49m[41m,[49m[41m [49m[41mbins[49m[38;5;241;41m=[39;49m[38;5;124;41m'[39;49m[38;5;124;41mauto[39;49m[38;5;124;41m'[39;49m[41m,[49m[41m [49m[41mdensity[49m[38;5;241;41m=[39;49m[38;5;28;41;01mTrue[39;49;00m[41m,[49m[41m [49m[41mhisttype[49m[38;5;241;41m=[39;49m[38;5;124;41m'[39;49m[38;5;124;41mstep[39;49m[38;5;124;41m'[39;49m[41m)[49m
[1;32m      4[0m ax[[38;5;241m0[39m][38;5;241m.[39mset_xlabel([38;5;124m'[39m[38;5;124mOSI[39m[38;5;124m'[39m)
[1;32m      5[0m ax[[38;5;241m0[39m][38;5;241m.[39mset_ylabel([38;5;124m'[39m[38;5;124mDensity[39m[38;5;124m'[39m)

File [0;32m~/mambaforge/envs/torch/lib/python3.10/site-packages/matplotlib/__init__.py:1465[0m, in [0;36m_preprocess_data.<locals>.inner[0;34m(ax, data, *args, **kwargs)[0m
[1;32m   1462[0m [38;5;129m@functools[39m[38;5;241m.[39mwraps(func)
[1;32m   1463[0m [38;5;28;01mdef[39;00m [38;5;21minner[39m(ax, [38;5;241m*[39margs, data[38;5;241m=[39m[38;5;28;01mNone[39;00m, [38;5;241m*[39m[38;5;241m*[39mkwargs):
[1;32m   1464[0m     [38;5;28;01mif[39;00m data [38;5;129;01mis[39;00m [38;5;28;01mNone[39;00m:
[0;32m-> 1465[0m         [38;5;28;01mreturn[39;00m [41mfunc[49m[41m([49m[41max[49m[41m,[49m[41m [49m[38;5;241;41m*[39;49m[38;5;28;41mmap[39;49m[41m([49m[41msanitize_sequence[49m[41m,[49m[41m [49m[41margs[49m[41m)[49m[41m,[49m[41m [49m[38;5;241;41m*[39;49m[38;5;241;41m*[39;49m[41mkwargs[49m[41m)[49m
[1;32m   1467[0m     bound [38;5;241m=[39m new_sig[38;5;241m.[39mbind(ax, [38;5;241m*[39margs, [38;5;241m*[39m[38;5;241m*[39mkwargs)
[1;32m   1468[0m     auto_label [38;5;241m=[39m (bound[38;5;241m.[39marguments[38;5;241m.[39mget(label_namer)
[1;32m   1469[0m                   [38;5;129;01mor[39;00m bound[38;5;241m.[39mkwargs[38;5;241m.[39mget(label_namer))

File [0;32m~/mambaforge/envs/torch/lib/python3.10/site-packages/matplotlib/axes/_axes.py:6854[0m, in [0;36mAxes.hist[0;34m(self, x, bins, range, density, weights, cumulative, bottom, histtype, align, orientation, rwidth, log, color, label, stacked, **kwargs)[0m
...
[0;32m-> 6854[0m     m, bins [38;5;241m=[39m [41mnp[49m[38;5;241;41m.[39;49m[41mhistogram[49m[41m([49m[41mx[49m[41m[[49m[41mi[49m[41m][49m[41m,[49m[41m [49m[41mbins[49m[41m,[49m[41m [49m[41mweights[49m[38;5;241;41m=[39;49m[41mw[49m[41m[[49m[41mi[49m[41m][49m[41m,[49m[41m [49m[38;5;241;41m*[39;49m[38;5;241;41m*[39;49m[41mhist_kwargs[49m[41m)[49m
...
File [0;32m~/mambaforge/envs/torch/lib/python3.10/site-packages/numpy/lib/histograms.py:780[0m, in [0;36mhistogram[0;34m(a, bins, range, density, weights)[0m
...
[0;32m--> 780[0m bin_edges, uniform_bins [38;5;241m=[39m [41m_get_bin_edges[49m[41m([49m[41ma[49m[41m,[49m[41m [49m[41mbins[49m[41m,[49m[41m [49m[38;5;28;41mrange[39;49m[41m,[49m[41m [49m[41mweights[49m[41m)[49m
...
File [0;32m~/mambaforge/envs/torch/lib/python3.10/site-packages/numpy/lib/histograms.py:396[0m, in [0;36m_get_bin_edges[0;34m(a, bins, range, weights)[0m
...
[0;32m--> 396[0m first_edge, last_edge [38;5;241m=[39m [41m_get_outer_edges[49m[41m([49m[41ma[49m[41m,[49m[41m [49m[38;5;28;41mrange[39;49m[41m)[49m
...
File [0;32m~/mambaforge/envs/torch/lib/python3.10/site-packages/numpy/lib/histograms.py:323[0m, in [0;36m_get_outer_edges[0;34m(a, range)[0m
...
[0;31m---------------------------------------------------------------------------[0m
[0;31mValueError[0m                                Traceback (most recent call last)
Cell [0;32mIn[111], line 59[0m
[1;32m     54[0m     [38;5;28;01mreturn[39;00m width_estimates [38;5;241m*[39m [38;5;241m180[39m [38;5;241m/[39m np[38;5;241m.[39mpi, skewness_estimates
[1;32m     56[0m [38;5;66;03m# Example usage[39;00m
[1;32m     57[0m
[1;32m     58[0m [38;5;66;03m# tuning_width, skewness = fit_gaussian_and_estimate_params(mean_rates.cpu().detach().numpy(), angles.cpu().numpy())[39;00m
[0;32m---> 59[0m tuning_width, skewness [38;5;241m=[39m [41mfit_gaussian_and_estimate_params[49m[41m([49m[41mnormalized_rates[49m[41m,[49m[41m [49m[41mangles[49m[38;5;241;41m.[39;49m[41mcpu[49m[41m([49m[41m)[49m[38;5;241;41m.[39;49m[41mnumpy[49m[41m([49m[41m)[49m[41m)[49m

Cell [0;32mIn[111], line 33[0m, in [0;36mfit_gaussian_and_estimate_params[0;34m(mean_rates, angles)[0m
[1;32m     31[0m [38;5;66;03m# Fit Gaussian[39;00m
[1;32m     32[0m [38;5;28;01mtry[39;00m:
[0;32m---> 33[0m     popt, _ [38;5;241m=[39m [41mcurve_fit[49m[41m([49m[41mgaussian[49m[41m,[49m[41m [49m[41munique_angles[49m[41m,[49m[41m [49m[41mresponses[49m[41m,[49m[41m [49m[41mp0[49m[38;5;241;41m=[39;49m[41minitial_guess[49m[41m)[49m
[1;32m     34[0m     mu, sigma, amplitude [38;5;241m=[39m popt
[1;32m     36[0m     [38;5;66;03m# Save the width and inferred skewness[39;00m

File [0;32m~/mambaforge/envs/torch/lib/python3.10/site-packages/scipy/optimize/_minpack_py.py:888[0m, in [0;36mcurve_fit[0;34m(f, xdata, ydata, p0, sigma, absolute_sigma, check_finite, bounds, method, jac, full_output, nan_policy, **kwargs)[0m
[1;32m    886[0m [38;5;66;03m# optimization may produce garbage for float32 inputs, cast them to float64[39;00m
[1;32m    887[0m [38;5;28;01mif[39;00m check_finite:
[0;32m--> 888[0m     ydata [38;5;241m=[39m [41mnp[49m[38;5;241;41m.[39;49m[41masarray_chkfinite[49m[41m([49m[41mydata[49m[41m,[49m[41m [49m[38;5;28;41mfloat[39;49m[41m)[49m
[1;32m    889[0m [38;5;28;01melse[39;00m:
[1;32m    890[0m     ydata [38;5;241m=[39m np[38;5;241m.[39masarray(ydata, [38;5;28mfloat[39m)

File [0;32m~/mambaforge/envs/torch/lib/python3.10/site-packages/numpy/lib/function_base.py:630[0m, in [0;36masarray_chkfinite[0;34m(a, dtype, order)[0m

...
#+RESULTS:
: 1024
: EE post 0 pre 0 Jab tensor(0.0632, device='cuda:1') torch.Size([750, 750])
...
#+RESULTS:
: torch.Size([1024, 1]) torch.Size([1024, 2, 1])
: torch.Size([1024, 61, 750])
...
: rates (100, 1024, 61, 750)
: curr (100, 1024, 1) prev (100, 1024, 1)
...
#+RESULTS:
[[file:./figures/bodr_seq_sb/figure_20.png]]
...
#+RESULTS:
[[file:./figures/bodr_seq_sb/figure_21.png]]
...
#+RESULTS:
: (51200, 1) (51200, 1) (51200, 1) (50, 1024, 61)
...
#+RESULTS:
[[file:./figures/bodr_seq_sb/figure_32.png]]
...
#+RESULTS:
[[file:./figures/bodr_seq_sb/figure_33.png]]
...
#+RESULTS:
: (51200, 1) (51200, 1) (51200, 1) (51200, 1)
...
#+RESULTS:
[[file:./figures/bodr_seq_sb/figure_39.png]]
...
#+RESULTS:
[[file:./figures/bodr_seq_sb/figure_41.png]]
...
:RESULTS:
: (2, 100)
[[file:./figures/bodr_seq_sb/figure_45.png]]
:END:
...
#+RESULTS:
[[file:./figures/bodr_seq_sb/figure_46.png]]

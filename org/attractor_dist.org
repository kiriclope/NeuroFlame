...
#+RESULTS:
: Elapsed (with compilation) = 0h 4m 34s
...
:       2 rates_fp = torch.stack(rates_fp).cpu().numpy()
:       3 rates_cr_list = torch.stack(rates_cr_list).cpu().numpy()
: 
...
#+begin_src ipython
  ...
  #+RESULTS:
  [[file:./.ob-jupyter/c61e3e2bdec5aa9b0b2634e242016146a9149348.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/9912938d4f2692e137083ef5f8acc66818841288.png]]
...
#+RESULTS:
: dist [2.6514316 1.3263845 2.8296945 2.237578  2.764404  2.2827437 2.5727763
:  1.2241459 2.3468068 1.9901702]
: perf_list [ 56.875004  79.6875   100.        76.25001   76.25001   96.5625
:  100.        55.        97.1875    89.375   ]
: perf_cr_list [ 59.375   81.25   100.      50.      85.9375 100.      98.4375  89.0625
:   53.125   93.75  ]
...
#+RESULTS:
[[file:./.ob-jupyter/957529759616db723192784d9bd63ee5bce7e55d.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/70bf96bbf0e4f249d895a5cf731a61def36e64af.png]]

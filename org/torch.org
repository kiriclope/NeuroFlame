...
#+begin_example
  ...
  Ja0 [2.0, 1.0]
  Generating ff input
  times (s) 0.0 rates (Hz) [0.19, 0.48]
  times (s) 0.09 rates (Hz) [0.2, 0.48]
  times (s) 0.18 rates (Hz) [0.2, 0.49]
  times (s) 0.27 rates (Hz) [0.21, 0.49]
  times (s) 0.36 rates (Hz) [0.21, 0.5]
  times (s) 0.45 rates (Hz) [0.2, 0.49]
  times (s) 0.54 rates (Hz) [0.21, 0.49]
  times (s) 0.63 rates (Hz) [0.22, 0.51]
  times (s) 0.72 rates (Hz) [0.2, 0.51]
  times (s) 0.81 rates (Hz) [0.19, 0.5]
  times (s) 0.9 rates (Hz) [2.62, 2.92]
  times (s) 0.99 rates (Hz) [1.85, 4.47]
  times (s) 1.08 rates (Hz) [3.0, 6.14]
  times (s) 1.17 rates (Hz) [3.81, 7.38]
  times (s) 1.26 rates (Hz) [3.91, 7.66]
  times (s) 1.35 rates (Hz) [3.98, 7.64]
  times (s) 1.44 rates (Hz) [4.32, 8.11]
  times (s) 1.53 rates (Hz) [4.6, 8.36]
  times (s) 1.62 rates (Hz) [4.06, 8.13]
  times (s) 1.71 rates (Hz) [4.73, 8.69]
  times (s) 1.8 rates (Hz) [4.87, 9.16]
  times (s) 1.89 rates (Hz) [4.24, 8.16]
  times (s) 1.98 rates (Hz) [4.6, 8.8]
  times (s) 2.07 rates (Hz) [4.25, 8.68]
  times (s) 2.16 rates (Hz) [4.37, 8.78]
  times (s) 2.25 rates (Hz) [4.36, 8.75]
  times (s) 2.34 rates (Hz) [3.55, 7.71]
  times (s) 2.43 rates (Hz) [7.98, 12.37]
  times (s) 2.52 rates (Hz) [3.97, 8.05]
  times (s) 2.61 rates (Hz) [6.29, 11.16]
  times (s) 2.7 rates (Hz) [5.76, 9.86]
  times (s) 2.79 rates (Hz) [4.16, 8.84]
  times (s) 2.88 rates (Hz) [5.16, 9.85]
  times (s) 2.97 rates (Hz) [4.01, 8.23]
  times (s) 3.06 rates (Hz) [4.61, 8.74]
  times (s) 3.15 rates (Hz) [4.02, 8.47]
  times (s) 3.24 rates (Hz) [4.58, 8.78]
  times (s) 3.33 rates (Hz) [4.54, 8.73]
  times (s) 3.42 rates (Hz) [5.75, 9.83]
  times (s) 3.51 rates (Hz) [3.92, 8.21]
  times (s) 3.6 rates (Hz) [6.88, 11.24]
  times (s) 3.69 rates (Hz) [4.03, 8.18]
  times (s) 3.78 rates (Hz) [5.82, 10.52]
  times (s) 3.87 rates (Hz) [4.6, 8.52]
  times (s) 3.96 rates (Hz) [4.69, 9.47]
  times (s) 4.05 rates (Hz) [4.77, 8.96]
  times (s) 4.14 rates (Hz) [4.08, 8.44]
  times (s) 4.23 rates (Hz) [6.6, 11.1]
  times (s) 4.32 rates (Hz) [3.9, 8.02]
  times (s) 4.41 rates (Hz) [5.07, 9.72]
  times (s) 4.5 rates (Hz) [4.65, 8.79]
  times (s) 4.59 rates (Hz) [3.92, 8.28]
  times (s) 4.68 rates (Hz) [5.64, 9.81]
  times (s) 4.77 rates (Hz) [4.28, 8.21]
  times (s) 4.86 rates (Hz) [6.52, 11.52]
  times (s) 4.95 rates (Hz) [6.79, 10.8]
  times (s) 5.05 rates (Hz) [4.32, 8.44]
  times (s) 5.14 rates (Hz) [5.38, 10.46]
  times (s) 5.23 rates (Hz) [6.2, 10.53]
  times (s) 5.32 rates (Hz) [3.53, 8.08]
  times (s) 5.41 rates (Hz) [6.6, 11.58]
  times (s) 5.5 rates (Hz) [4.3, 8.17]
  times (s) 5.59 rates (Hz) [5.9, 11.18]
  times (s) 5.68 rates (Hz) [7.78, 12.32]
  times (s) 5.77 rates (Hz) [3.9, 8.05]
  times (s) 5.86 rates (Hz) [6.88, 12.2]
  times (s) 5.95 rates (Hz) [4.82, 9.0]
  times (s) 6.04 rates (Hz) [4.99, 9.67]
  times (s) 6.13 rates (Hz) [5.16, 9.5]
  times (s) 6.22 rates (Hz) [4.62, 8.92]
  times (s) 6.31 rates (Hz) [3.95, 8.44]
  times (s) 6.4 rates (Hz) [5.39, 10.0]
  times (s) 6.49 rates (Hz) [5.27, 9.3]
  times (s) 6.58 rates (Hz) [4.05, 8.53]
  times (s) 6.67 rates (Hz) [7.84, 12.9]
  times (s) 6.76 rates (Hz) [4.52, 8.47]
  times (s) 6.85 rates (Hz) [5.17, 9.63]
  times (s) 6.94 rates (Hz) [8.81, 13.17]
  times (s) 7.03 rates (Hz) [4.28, 8.4]
  times (s) 7.12 rates (Hz) [5.52, 10.49]
  times (s) 7.21 rates (Hz) [5.61, 9.78]
  times (s) 7.3 rates (Hz) [3.99, 8.23]
  times (s) 7.39 rates (Hz) [8.38, 13.48]
  times (s) 7.48 rates (Hz) [4.08, 8.18]
  times (s) 7.57 rates (Hz) [4.81, 9.54]
  times (s) 7.66 rates (Hz) [7.42, 12.17]
  times (s) 7.75 rates (Hz) [4.93, 8.62]
  times (s) 7.84 rates (Hz) [4.84, 9.8]
  times (s) 7.93 rates (Hz) [5.77, 10.21]
  times (s) 8.02 rates (Hz) [4.29, 8.37]
  times (s) 8.11 rates (Hz) [5.02, 10.06]
  times (s) 8.2 rates (Hz) [9.03, 13.84]
  times (s) 8.29 rates (Hz) [4.25, 8.25]
  times (s) 8.38 rates (Hz) [4.81, 9.68]
  times (s) 8.47 rates (Hz) [9.57, 14.01]
  times (s) 8.56 rates (Hz) [3.74, 7.78]
  times (s) 8.65 rates (Hz) [5.45, 10.2]
  times (s) 8.74 rates (Hz) [7.04, 10.8]
  times (s) 8.83 rates (Hz) [3.89, 8.6]
  times (s) 8.92 rates (Hz) [4.3, 8.94]
  times (s) 9.01 rates (Hz) [3.75, 7.73]
  Elapsed (with compilation) = 7.950953792780638s
...
:RESULTS:
: (1, 11100, 2000)
[[file:./.ob-jupyter/b74cbde3df9d5362768b5881d6250aae484ad774.png]]
:END:
...
#+RESULTS:
[[file:./.ob-jupyter/9c438d30415099fd726a4e6064e95e211f94964d.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/45a2e834282b309c2662c74f6d3d0d79e2673984.png]]
...
#+begin_src ipython
  ...
  model = Network(conf_name, name, REPO_ROOT, VERBOSE=0, DEVICE='cuda',
                  N_BATCH=500, SEED=seed, LR_COV=LR_COV,
...
:RESULTS:
: (500, 101)
[[file:./.ob-jupyter/4e530d4ba9808e8a02ce6b3e294dc21257a2d8a3.png]]
:END:
...
#+RESULTS:
[[file:./.ob-jupyter/1649d9366b5ee3075ca5ca2cb782da4f82154661.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/2d198e57ee7c1365d760471a2a513d1b6dbcd3ca.png]]
...
:RESULTS:
: (500, 101, 2000)
[[file:./.ob-jupyter/2dc7696e7944e28ccd3286635490c7acc35ff87c.png]]
:END:
...
:RESULTS:
: (500, 101)
[[file:./.ob-jupyter/bde411284528abd966143a654a4a41a561803339.png]]
:END:

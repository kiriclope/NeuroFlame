...
#+begin_src ipython
  ...
  Wij = Con('all2all', 'lr', kappa=5, lr_mean=[0, 0], lr_cov=[[1, 0], [0, 1]])
#+end_src
...
#+RESULTS:
[[file:./.ob-jupyter/1121dbb947e42fc6d30c5e616d11a1db7dedf6e6.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/6a0df45178cabdf6f93b17680e12a8375ca65433.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/96deb8001d31e72242353d8ed023a546284188e6.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/62cbe8703fd3bed1cfba6c01b5e468a613214425.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/90197594d2894e6e83595200f113674f951a5b0f.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/afd87d7dcdbd88d46c20c8eb9b47446e9d319f17.png]]

** from model

#+begin_src ipython
  REPO_ROOT = "/home/leon/models/NeuroTorch"
  model = Network('config_2pop.yml', 'None', REPO_ROOT, VERBOSE=0, DEVICE='cuda', IF_STP=0, DT=0.005, GAIN=1.0)
...
#+begin_src ipython
  ...
  model.USE = torch.tensor(USE, device='cuda').unsqueeze(-1)
  model.N_BATCH = 10

  rates_use = model(REC_LAST_ONLY=0).cpu().detach().numpy()
...
#+begin_src ipython
  ...
  TAU_FAC = []  
  for i in np.linspace(350, 1000, 10):
      TAU_FAC.append(i)

  model.TAU_FAC = torch.tensor(TAU_FAC, device='cuda').unsqueeze(-1)
  model.N_BATCH = 10

  rates_fac = model(REC_LAST_ONLY=0).cpu().detach().numpy()
...
:RESULTS:
: (1, 101, 8000)
[[file:./.ob-jupyter/3007ae4feaef0c3dfaf3d635fe21704091ff96a6.png]]
:END:
...
#+RESULTS:
[[file:./.ob-jupyter/4712b4f3a614c3a1c8c2f016ff7c52189fd5408f.png]]

...
#+RESULTS:
: GPU 0 Memory Usage: 3.92%
: GPU 1 Memory Usage: 4.00%
...
#+begin_src ipython
  Cij = Connectivity(1000, 1000, 1.0)('all2all', 'von_mises', kappa=.10, sigma=0, phase=0)
#+end_src
...
#+RESULTS:
[[file:./.ob-jupyter/805db560325611cb5d8cc955757ec61fcaa2db35.png]]
